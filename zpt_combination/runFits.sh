...
combine -M MultiDimFit inputs/workspace_zll.root --saveFitResult -n zll_correlation
combine -M MultiDimFit inputs/workspace_znn.root --saveFitResult -n znn_correlation
combine -M MultiDimFit inputs/workspace_zxx.root --saveFitResult -n zxx_correlation


combine -M MultiDimFit inputs/workspace_zmm.root        -n zmm_obs        --algo=singles --robustFit=1 > zmm_obs.txt
combine -M MultiDimFit inputs/workspace_zee.root        -n zee_obs        --algo=singles --robustFit=1 > zee_obs.txt
combine -M MultiDimFit inputs/workspace_zll.root        -n zll_obs        --algo=singles --robustFit=1 > zll_obs.txt
combine -M MultiDimFit inputs/workspace_znn.root        -n znn_obs        --algo=singles --robustFit=1 > znn_obs.txt
combine -M MultiDimFit inputs/workspace_zxx.root        -n zxx_obs        --algo=singles --robustFit=1 > zxx_obs.txt
combine -M MultiDimFit inputs/workspace_zmm_total.root  -n zmm_total_obs  --algo=singles --robustFit=1 > zmm_total_obs.txt
combine -M MultiDimFit inputs/workspace_zee_total.root  -n zee_total_obs  --algo=singles --robustFit=1 > zee_total_obs.txt
combine -M MultiDimFit inputs/workspace_zmm_total0.root  -n zmm_total0_obs  --algo=singles --robustFit=1 > zmm_total0_obs.txt
combine -M MultiDimFit inputs/workspace_zee_total0.root  -n zee_total0_obs  --algo=singles --robustFit=1 > zee_total0_obs.txt
combine -M MultiDimFit inputs/workspace_zll_total.root  -n zll_total_obs  --algo=singles --robustFit=1 > zll_total_obs.txt
combine -M MultiDimFit inputs/workspace_zll_total0.root -n zll_total0_obs --algo=singles --robustFit=1 > zll_total0_obs.txt
#combine -M MultiDimFit inputs/workspace_zll_total1.root -n zll_total1_obs --algo=singles --robustFit=1 
combine -M MultiDimFit inputs/workspace_znn_total.root  -n znn_total_obs  --algo=singles --robustFit=1 > znn_total_obs.txt
combine -M MultiDimFit inputs/workspace_znn_total0.root -n znn_total0_obs --algo=singles --robustFit=1 > znn_total0_obs.txt
#combine -M MultiDimFit inputs/workspace_znn_total1.root -n znn_total1_obs --algo=singles --robustFit=1 
combine -M MultiDimFit inputs/workspace_zxx_total.root  -n zxx_total_obs  --algo=singles --robustFit=1 > zxx_total_obs.txt
combine -M MultiDimFit inputs/workspace_zxx_total0.root -n zxx_total0_obs --algo=singles --robustFit=1 > zxx_total0_obs.txt
