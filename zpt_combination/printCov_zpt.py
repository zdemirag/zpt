...
for obs in ['zll_correlation',"znn_correlation","zxx_correlation"]:#['r_zcat0','r_zcat1','r_zcat2','r_zcat3','r_zcat4','r_zcat5']:
#for obs in ['pT4l','rapidity4l','njets_pt30_eta2p5','pt_leadingjet_pt30_eta2p5']:
  ...
  axisLabel="p_{T}^{Z} [GeV]"
  poi0 = RooRealVar("r_s0","r_s0",0,10)  
  poi1 = RooRealVar("r_s1","r_s1",0,10)  
  poi2 = RooRealVar("r_s2","r_s2",0,10)  
  poi3 = RooRealVar("r_s3","r_s3",0,10)  
  poi4 = RooRealVar("r_s4","r_s4",0,10)  
  poi5 = RooRealVar("r_s5","r_s5",0,10)  
  poi6 = RooRealVar("r_s6","r_s6",0,10)      
  ...
  for i in range(len(label)):
    ...
    for j in range(len(label)):
      ...
      #  line +=" "+str(round(r.correlation("r_s"+str(max(i-1,0)),"r_s"+str(max(j-1,0))),3))+";"
      #  h_obs.SetBinContent(i+1,j+1,r.correlation("r_s"+str(max(i-1,0)),"r_s"+str(max(j-1,0))))      
      #else:
      line +=" "+str(round(r.correlation("r_s"+str(i),"r_s"+str(j)),3))+";"
      h_obs.SetBinContent(i+1,j+1,r.correlation("r_s"+str(i),"r_s"+str(j)))
