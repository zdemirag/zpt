...
out_file_name = 'mono-x_pusys.root'

bins =[250,275,300,350,400,450,500,650,800,1150,1500]
systematics=["pu"]

infile = "/desktop/05a/zdemirag/fittingnlo_test5/fittingForest_all.root"
...
signal_category_0 = {
	    'name':"signal_cat0"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && ((genBosonPt >=-1 && genBosonPt <200) || (genJetPt<100)))"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
...
signal_category_1 = {
	    'name':"signal_cat1"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=200 && genBosonPt <300 && genJetPt>=100)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                    "Zvv_nlo_signal"           :['signal','zjets_1',1,1]
                  }
}
...
signal_category_2 = {
	    'name':"signal_cat2"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=300 && genBosonPt <400 && genJetPt>=100)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                    "Zvv_nlo_signal"           :['signal','zjets_2',1,1]
                  }
}
...
signal_category_3 = {
	    'name':"signal_cat3"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=400 && genBosonPt <500 && genJetPt>=100)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                    "Zvv_nlo_signal"           :['signal','zjets_3',1,1]
                  }
}
...
signal_category_4 = {
	    'name':"signal_cat4"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=500 && genBosonPt <800 && genJetPt>=100)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                    "Zvv_nlo_signal"           :['signal','zjets_4',1,1]
                  }
}
signal_category_5 = {
	    'name':"signal_cat5"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=800 && genJetPt>=100)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            #,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                    "Zvv_nlo_signal"           :['signal','zjets_5',1,1]
                  }
}
