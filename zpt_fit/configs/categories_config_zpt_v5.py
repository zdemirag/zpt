...
infile = "/desktop/05a/v2/fittingnlo/fittingForest_all.root"
...
signal_category_5 = {
	    'name':"signal_cat5"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=800 && genBosonPt<1500)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            ,"additionalvars":[['met',100,250,3000]]
...
signal_category_6 = {
	    'name':"signal_cat6"
            ,'in_file_name':infile
            ,"cutstring":"(met>250 && genBosonPt >=1500)"
            ,"varstring":["met",250,3000]
            ,"weightname":"weight"
            ,"bins":bins[:]
            ,"additionalvars":[['met',100,250,3000]]
	   	...
	   	{  
		  # Signal Region
                  "Zvv_nlo_signal"           :['signal','zjets_6',1,0]
                  }
}
