...
def plotPreFitPostFit(region,category,sb=False,setPull=True):
  ...
  ##prefit
  h_signal0_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat0")
  h_signal1_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat1")
  h_signal2_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat2")
  h_signal3_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat3")
  h_signal4_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat4")
  h_signal5_pre = f_mlfit.Get("shapes_prefit/ch2_monojet_signal/zcat5")
  ...
  ##postfit
  h_signal0 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat0")
  h_signal1 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat1")
  h_signal2 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat2")
  h_signal3 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat3")
  h_signal4 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat4")
  h_signal5 = f_mlfit.Get("shapes_fit_s/ch2_monojet_signal/zcat5")
  ...
  print "shapes_fit_s/"+channel[region]+"/total_background"
...
plotPreFitPostFit("singlemuon","ch2_monojet", setPull=True)
plotPreFitPostFit("singleelectron","ch2_monojet", setPull=True)
plotPreFitPostFit("signal","ch2_monojet", setPull=True)
