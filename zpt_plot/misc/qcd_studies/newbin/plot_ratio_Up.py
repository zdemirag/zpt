...
infile = TFile("qcd_abcd_Up.root","read")
...
def ratio(model):
    ...
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/all_"+model+".pdf")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/all_"+model+".png")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/all_"+model+".C")
...
def main(model):
    ...
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/fitregion_"+model+".png")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/fitregion_"+model+".pdf")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/fitregion_"+model+".C")
    ...
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/closureregion_"+model+".png")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/closureregion_"+model+".pdf")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/closureregion_"+model+".C")
    ...
    func.SetParameter(0,-6.61)
    func.SetParameter(1,0.013)
    func.SetParameter(2,6.9)
    func.SetParameter(3,-0.0079)
    ...
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/inc_fit_"+model+".png")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/inc_fit_"+model+".pdf")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Up/inc_fit_"+model+".C")
