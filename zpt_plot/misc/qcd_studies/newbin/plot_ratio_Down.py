...
def ratio(model):
    ...
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/all_"+model+".pdf")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/all_"+model+".png")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/all_"+model+".C")
...
def main(model):
    ...
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/fitregion_"+model+".png")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/fitregion_"+model+".pdf")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/fitregion_"+model+".C")
    ...
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/closureregion_"+model+".png")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/closureregion_"+model+".pdf")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/closureregion_"+model+".C")
    ...
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/inc_fit_"+model+".png")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/inc_fit_"+model+".pdf")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/Down/inc_fit_"+model+".C")
