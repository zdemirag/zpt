...
def ratio(model):
    ...
    if model is "QCD":
        frame = c.DrawFrame(100,1e-8,1500,1e2);
    else:
    ...
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/all_"+model+".pdf")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/all_"+model+".png")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/all_"+model+".C")
...
def main(model):
    ...
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/fitregion_"+model+".png")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/fitregion_"+model+".pdf")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/fitregion_"+model+".C")
    ...
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/closureregion_"+model+".png")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/closureregion_"+model+".pdf")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/closureregion_"+model+".C")
    ...
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/inc_fit_"+model+".png")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/inc_fit_"+model+".pdf")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd2/inc_fit_"+model+".C")
