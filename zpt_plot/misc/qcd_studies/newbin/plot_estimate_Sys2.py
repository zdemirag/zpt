...
funcup.SetParameter(0,-5.018)
funcup.SetParameter(1,-0.001941)
funcup.SetParameter(2,2.853)
funcup.SetParameter(3,-0.03123)
...
leg = TLegend(.55,.8,1.0,0.9)                                                                                                                                                     
leg.SetFillStyle(0)                                                                                                                                                             
leg.SetBorderSize(0)                                                                                                                                                            
leg.AddEntry(hb ,"Data driven estimation","l")                                                                                                                                    
leg.AddEntry(hb_down ,"+/- Fit, scale and resolution variations","l")                                                                                                                                     
leg.Draw("same")
...
hd.Sumw2()
ratio = plot_ratio(False,hb_clone,hb_up,"p_{T}^{miss} [GeV]","ratio",-1,3,5)
