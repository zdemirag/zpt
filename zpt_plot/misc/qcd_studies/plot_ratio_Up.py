...
def ratio(model):
    ...
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/all_"+model+".pdf")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/all_"+model+".png")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/all_"+model+".C")
...
def main(model):
    ...
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/fitregion_"+model+".png")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/fitregion_"+model+".pdf")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/fitregion_"+model+".C")
    ...
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/closureregion_"+model+".png")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/closureregion_"+model+".pdf")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/closureregion_"+model+".C")
    ...
    func = TF1("func","exp([0]+([1]*exp([2]+[3]*x)))")
    ...
    func.SetParameter(3,-0.0069)
    #func.SetParameter(4,0.005)

    inc_fit.Fit(func)

    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/inc_fit_"+model+".png")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/inc_fit_"+model+".pdf")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/Up/inc_fit_"+model+".C")
