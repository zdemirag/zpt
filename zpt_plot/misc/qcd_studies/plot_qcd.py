...
for hist in dirList: 
    ...
    c[i].SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/"+hist.GetName()+".png")
    c[i].SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/"+hist.GetName()+".pdf")
    c[i].SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/"+hist.GetName()+".C")
