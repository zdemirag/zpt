...
def ratio(model):
    ...
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/all_"+model+".pdf")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/all_"+model+".png")
    c.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/all_"+model+".C")
...
def main(model):
    ...
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/fitregion_"+model+".png")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/fitregion_"+model+".pdf")
    c1.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/fitregion_"+model+".C")
    ...
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/closureregion_"+model+".png")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/closureregion_"+model+".pdf")
    c2.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/closureregion_"+model+".C")
    ...
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/inc_fit_"+model+".png")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/inc_fit_"+model+".pdf")
    c3.SaveAs("/afs/cern.ch/user/z/zdemirag/www/zpt/panda/qcd/inc_fit_"+model+".C")
